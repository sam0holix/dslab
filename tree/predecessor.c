...
printf("%d %d",k,k1);
if(j1==0)
printf("\nhas no inorder predecessor.");
else
printf("\ninorder Predecessor: %d.",in[j1-1]);
if(k1==0)
printf("\nhas no postorder predecessor.");
else
printf("\npostorder predecessor: %d.",post[k1-1]);
if(i1==0)
printf("\nhas no preorder predecessor.");
else
printf("\npreorder Predecessor: %d.",pre[i1-1]);
}
